...
const FrequentVisitorForm = ({ handleSubmit, visitorData, setVisitorData }) => {
			...
			<div className="container">
				<div className="form-1">
					...
					<div className="flex-container">
						<label className="form-label mt-3 flex-item">
							{t('visitor name')}
							<input
								type="text"
								className="form-control mb-3"
				...
				<div className="form-2">
					<label style={{ marginRight: '10px' }} className="form-label mt-3">
						{t('Frequent Apartment')}
						<input
							type="text"
							className="form-control mb-3"
							name="frequentApartment"
							placeholder={t('Enter the frequent residence')}
							value={visitorData.frequentApartment}
							onChange={handleInputChange}
							required
						/>
					</label>
...
export default FrequentVisitorForm;
